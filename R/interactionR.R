...
#' \dontrun{interactionR(model.prev, exposure_names = c("exp1", "exp2"),
#'              ci.type = "delta", ci.level = 0.95,
#'              em = FALSE, recode = FALSE)}
#'
...
#'
#' interactionR(model.prev, exposure_names = c("exp1", "exp2"),
#'              ci.type = "delta", ci.level = 0.95,
